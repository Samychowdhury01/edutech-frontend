...
const AppDownloadSection = () => {
    return (
        <Container>
      <div className="grid grid-cols-1 overflow-hidden rounded-[20px] bg-black bg-gradient-to-tr from-[#062C30] via-[#141B41] to-[#1B1B3A]'  py-2 md:grid-cols-2 md:px-10 my-10 md:my-20">
        {/* text container */}
